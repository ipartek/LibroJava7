...
public class HundirFlota {
	...
	private static void hundirFlout() throws IOException {
		...
		boolean tabla = false, winner = false, disparo = false;

		int fials = 1, columnas = 1;
		...
		String[][] tablero = new String[fials][columnas];
		String[][] tableroJugador = new String[fials][columnas];
